...
// @ts-nocheck
// @ts-ignore
var __STORY__ = "import React, {useState} from \"react\";\n\nexport default {\n    title: 'Clock ',\n\n}\n\n\nexport const Clock = () => {\n\n\n    const [date, setDate] = useState<Date>(new Date((Date.now())))\n\n\n    const bla =()=> {\n        return setDate(data=>data.getSeconds())\n    }\n\n    const start = () => {\n        setInterval(() => {\n            setDate(new Date(bla()))\n        }, 1000)\n\n    };\n\n\n    return (\n        <div>\n             <span>\n                   {date.getHours()}\n                </span>\n:\n                <span>\n                   {date.getMinutes()}\n                </span>\n            :\n            <span>\n                   {date.getSeconds()}\n                </span>\n\n\n            <div>\n                <button\n                    onClick={start}\n                >\n                    start\n                </button>\n\n            </div>\n        </div>\n    )\n}\n\n\n";
// @ts-ignore
...
_s(Clock, "OmbomkvyJ2yWbsLQLUNAhBW4SSY=");
_c = Clock;
Clock.parameters = {
  storySource: {
    source: "() => {\n\n\n    const [date, setDate] = useState<Date>(new Date((Date.now())))\n\n\n    const bla =()=> {\n        return setDate(data=>data.getSeconds())\n    }\n\n    const start = () => {\n        setInterval(() => {\n            setDate(new Date(bla()))\n        }, 1000)\n\n    };\n\n\n    return (\n        <div>\n             <span>\n                   {date.getHours()}\n                </span>\n:\n                <span>\n                   {date.getMinutes()}\n                </span>\n            :\n            <span>\n                   {date.getSeconds()}\n                </span>\n\n\n            <div>\n                <button\n                    onClick={start}\n                >\n                    start\n                </button>\n\n            </div>\n        </div>\n    )\n}"
...
//# sourceMappingURL=main.9029ecda3e71256a1fbc.hot-update.js.map