...
const Clock = () => {
  ...
  const start = (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    setInterval(() => {
      setDate(new Date());
    }, 1000);
  }, []);
...
_s(Clock, "akz2RJW6ztNgwIaF/2u76184zzU=");
_c = Clock;
Clock.parameters = {
  storySource: {
    source: "() => {\n\n\n    const [date, setDate] = useState<Date>(new Date((Date.now())))\n\n\n\n    const start =useEffect( () => {\n        setInterval(() => {\n            setDate(new Date())\n        }, 1000)\n\n    },[])\n\n\n    return (\n        <div>\n             <span>\n                   {date.getHours()}\n                </span>\n:\n                <span>\n                   {date.getMinutes()}\n                </span>\n            :\n            <span>\n                   {date.getSeconds()}\n                </span>\n\n\n            <div>\n                <button\n                    onClick={start}\n                >\n                    start\n                </button>\n\n            </div>\n        </div>\n    )\n}"
...
//# sourceMappingURL=main.b96a34620926759ee8fa.hot-update.js.map